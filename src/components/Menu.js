...
class Menu extends Component {
  ...
  getItems(items, diameter) {
    ...
    return items.map((item, index) => (
      <Item key={index} item={item} hovered={this.hovered.bind(this)} unHovered={this.unHovered.bind(this)} radius={radius} angle={angle} initialAngle={(angle * index) + north} increment={angle} />
    ))
  }
